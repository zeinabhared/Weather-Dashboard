...
function renderForecast(dailyForecast, timezone) {
  ...
  heading.textContent = '5-Day Weather Forecast:';
...
function fetchCoords(search) {
  ...
  fetch(apiUrl)
    ...
    .then(function (data) {
      if (!data[0]) {
        alert('Location was not found! Try again!');
      } else {
...
function handleSearchFormSubmit(e) {
  // Will not continue if there is nothing in the search form
...
function handleSearchHistoryClick(e) {
  // Will not complete search if current elements is not a search history button
